package com.reclamation.pfe.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.reclamation.pfe.IntegrationTest;
import com.reclamation.pfe.repository.timezone.DateTimeWrapper;
import com.reclamation.pfe.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM reclamation_date_time_wrapper where id=%d", fieldName, id);
    }
